...
from headroom.configs.loader import register_schema
...
def _load_stage_registry(package: str = "headroom") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in headroom.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from headroom.configs.loader import config_to_dict, save_resolved_config
    from headroom.models.device import get_device
    from headroom.utils.logging import configure_logging
    from headroom.utils.reproducibility import set_seed
    from headroom.utils.run_manifest import create_run_dir, save_run_metadata
